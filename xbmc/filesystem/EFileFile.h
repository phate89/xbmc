...
public:
  ...
  static bool IsDisc(const CURL& url);
  static bool IsEFile(const CURL& url);
...
protected:
  static bool CEFileFile::GetXMLString(const CURL& url, std::string strRootElement, std::string strXMLTag, std::string& strValue = std::string());
